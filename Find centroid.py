...
#image = r"C:\Users\Asus\Desktop\LAB_TEST\DATA2\"  #Uncomment when find centroid of another image.
...
try :
    ...
    if len(contours1) > 0 :
        ...
        '''
        #Uncomment when find centroid of another image.
        IMG_coordinateX = cv2.line(gray_ref, (int(center_x),0), (int(center_x),3520), (255,255,255), 1)
        IMG_coordinateY = cv2.line(gray_ref, (0,int(center_y)), (4656,int(center_y)), (255,255,255), 1)
        '''
        # Normalized
